        ...
        <IonPage>
            <IonHeader >
                <IonToolbar>
                    ...
                    <IonTitle className='bg-lime-300 absolute my-auto top-0 bottom-0 left-0 right-0 text-center'>Record List</IonTitle>
                </IonToolbar>
            </IonHeader>
            <IonContent>
                ...
                <IonGrid className='justify-center items-center text-center w-full absolute bottom-11'>
                    <IonRow>
                        ...
                        <IonCol size="2" onClick={() => { setFliter(false); setSelectedList(''); setSelectedDate(new Date()) }}>
